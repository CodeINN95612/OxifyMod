...
REM Check if gradle.properties exists in parent directory
cd ..
if not exist "gradle.properties" (
    echo Error: gradle.properties not found in parent directory
    echo Please run this script from the tools subdirectory of the Oxify mod
    exit /b 1
)
